(function ($) {
	...
	if ($('.portfolio-slider').length) {
		const services_slider = new Swiper('.portfolio-slider .swiper', {
			slidesPerView : 1,
			speed: 1000,
			spaceBetween: 15,
			loop: true,
	...
	if ($('.team-slider').length) {
		const testimonial_slider = new Swiper('.team-slider .swiper', {
			slidesPerView : 1,
			speed: 1000,
			spaceBetween: 30,
			loop: true,
	...
	if ($('.slider-portfolio-for').length) {

		const portfolioThumbs = new Swiper('.slider-portfolio-nav .swiper', {
			slidesPerView: 4,
			spaceBetween: 10,
		...
		const portfolioMain = new Swiper('.slider-portfolio-for .swiper', {
			slidesPerView: 1,
			spaceBetween: 0,
			loop: true,
			speed: 1000,
